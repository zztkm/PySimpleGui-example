# コード公開元: https://github.com/narbehaj/ssl-checker
# LICENSE: GPL-3.0 https://github.com/narbehaj/ssl-checker/blob/master/LICENSE
# ちょっと改変を加えている
# いい感じになったらPR出しても良いかも、ついでに pip でインストールできるようにしたい
...
class SSLChecker:
    ...
    def get_args(self, json_args={}):
        ...
        if len(json_args) > 0:
            ...
            setattr(args, 'summary_true', True)
            return args
